...
function twentythirteen_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Header Text', 'twentythirteen' ),
		'id'            => 'sidebar-2',
		...
		register_sidebar( array(
		'name'          => __( 'Redes Sociales Header', 'twentythirteen' ),
		'id'            => 'sidebar-3',
		'description'   => __( 'Redes Sociales Header', 'twentythirteen' ),
		...
		'after_title'   => '</h3>',
			...
			register_sidebar( array(
		'name'          => __( 'Redes Sociales Mobile Footer', 'twentythirteen' ),
		'id'            => 'sidebar-4',
		'description'   => __( 'Redes Sociales Mobile Footer', 'twentythirteen' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget'  => '</div>',
		'before_title'  => '<h3 class="widget-title">',
		'after_title'   => '</h3>',
