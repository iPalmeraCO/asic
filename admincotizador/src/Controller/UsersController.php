...
//    }
    ...
    function views() {
        ...
        $infoView = [
            ...
            'cmdPass' => ['url' => ['controller' => 'users', 'action' => 'users_password'], 'title' => 'Cambiar Clave'],
        ];
    ...
    public function edit($id = null) {
        ...
        $grupoid=($this->Auth->user('group_id'));
        $listObj01 = $this->arrayTypeDoc; //Tipo de Documento       
        $arrayGroup = $this->arrayGroup;
        $this->set(compact('objData', 'infoView', 'listObj01','arrayGroup' ,'status', 'error', $this->set('switchOn', $this->switchOn), $this->set('switchOff', $this->switchOff),'grupoid'));
    }
