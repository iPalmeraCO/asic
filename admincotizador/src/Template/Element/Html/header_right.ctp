...
<ul class="nav navbar-nav pull-right">
    ...
    <li class="dropdown user" id="header-user">
        ...
        <ul class="dropdown-menu">
            ...
            echo '<li>'.$this->Html->link('<i class="fa fa-lock"></i> Cambiar Contraseña',['controller'=>'users','action'=>'users_password',$this->request->session()->read('Auth.User.id')],['escape'=>false]);
