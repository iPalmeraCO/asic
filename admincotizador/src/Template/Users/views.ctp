        ...
        <div class="panel panel-danger">
            ...
            <table id="dt_table_tools" class="table table-striped table-condensed">
                               <thead>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($listObj as $objData):
                                            ...
                                            foreach ($infoView['table'] as $obj):
                                                ...
                                                else if ($obj[0] == $rol_field) {
                                                    switch ($objData[$obj[0]]) {
                                                        case 10: $data = 'Administrador';
                                                            break;
                                                        case 20: $data = 'Arquitecto de Infraestructura';
                                                            break;
								...
								echo '</li>
                                                                     <li>';
                                            echo $this->Html->link('<i class="fa fa-lock"></i> '
                                                    .$infoView['cmdPass']['title']
                                                    ,$infoView['cmdPass']['url']+[0=>$objData['id']]
