...
--
-- Servidor: localhost
-- Tiempo de generación: 04-09-2015 a las 15:40:09
...
CREATE TABLE IF NOT EXISTS `canales` (
  ...
  `description_resource_units` text COMMENT 'Descripcion Unidad de recursos',
...
INSERT INTO `category` (`id`, `name`, `description`, `status_id`, `created`, `modified`) VALUES
(1, 'SERVIDORES', '', 1, '2015-07-28 16:29:59', '2015-09-04 14:43:18'),
(2, 'ALMACENAMIENTO', '', 1, NULL, '2015-09-04 14:43:23'),
(3, 'CUSTODIA Y TRASPORTE DE MEDIOS', '', 1, '2015-07-28 23:03:15', '2015-09-04 14:43:28'),
(4, 'COMUNICACIONES', '', 1, '2015-07-28 23:03:36', '2015-09-04 14:43:33'),
(5, 'MPLS', '', 1, '2015-07-28 23:03:53', '2015-09-04 14:43:38'),
(6, 'BACKUPS', '', 1, '2015-07-28 23:04:07', '2015-09-04 14:43:43'),
(7, 'MONITOREO', '', 1, '2015-07-28 23:04:27', '2015-09-04 14:43:48'),
(8, 'SOFTWARE SPLA', '', 1, '2015-07-28 23:04:46', '2015-09-04 14:45:07'),
(9, 'REPLICA', '', 1, '2015-07-28 23:05:00', '2015-09-04 14:45:12'),
(10, 'OTROS', '', 1, '2015-07-28 23:05:15', '2015-09-04 14:45:19'),
(11, 'ESPECIALISTAS', '', 1, '2015-07-30 09:36:45', '2015-09-04 14:45:25'),
(12, 'FACILITIES', '', 1, '2015-07-30 09:37:05', '2015-09-04 14:45:37'),
(13, 'ADMON SOPORTE', 'ADMINISTRACION SOPORTE', 1, '2015-07-30 09:56:21', '2015-09-04 14:45:31');
...
(1, 7, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, 0, '2015-09-01 11:17:34', '2015-09-01 11:17:34');
...
(7, 'elemento', 'descripcion', 1, 1, 1, 1, '2015-09-01 11:17:34', '2015-09-01 11:17:34');
...
CREATE TABLE IF NOT EXISTS `licencia_os` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `supported_oss` text COMMENT 'Versiones de Sistemas Operativos Soportados',
...
CREATE TABLE IF NOT EXISTS `packages` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Tabla para almacer los paquetes' AUTO_INCREMENT=2 ;

--
-- Volcado de datos para la tabla `packages`
--

INSERT INTO `packages` (`id`, `name`, `description`, `image`, `os_id`, `technology_id`, `status_id`, `created`, `modified`) VALUES
(1, 'Elemento 2', 'Descripcion Elemento 2', '', 1, 1, 1, '2015-09-01 11:19:20', '2015-09-01 11:19:20');
...
CREATE TABLE IF NOT EXISTS `packages_elements` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Id Primario',
