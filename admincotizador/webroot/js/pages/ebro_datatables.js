...
ebro_datatables = {
    ...
    scroll: function () {
        ...
        }else if ($('#dt_scroll2').length) {
//alert('Tenga en cuenta que si los datos no le aparecen actualizados al exportar, Refresque la pagina');
            $('#dt_scroll2').dataTable({
                "sScrollX": "100%",
                "sScrollXInner": '150%',
                "sPaginationType": "bootstrap",
                "bScrollCollapse": true,
		"sDom": "<'dt-top-row'Tlf>r<'dt-wrapper't><'dt-row dt-bottom-row'<'row'<'col-sm-6'i><'col-sm-6 text-right'p>>",
                ...
                "fnInitComplete": function (oSettings, json) {
                    $(this).closest('#dt_scroll2_wrapper').find('.DTTT.btn-group').addClass('table_tools_group').children('a.btn').each(function () {
